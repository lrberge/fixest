...
##### HR: See test-fitting.R for the following tests
chunk("ESTIMATION")
...
##### HR: See test-CornerCase.R for the following tests
chunk("Corner cases")
...
##### HR: See test-nointercept.R for the following tests
...
##### HR: See test-fitmethod.R for the following tests
chunk("Fit methods")
...
##### HR: See test-vcov.R for the following tests
...
#
##### HR: See test-sandwich.R for the following tests
library(sandwich)
...
#### Residuals ####
####
##### HR: See test-residuals.R for the following tests
chunk("RESIDUALS")
...
#### fixef ####
####
##### HR: See test-fixef.R for the following tests
chunk("FIXEF")
...
#### To Integer ####
####
##### HR: See test-to_integer.R for the following tests
chunk("TO_INTEGER")
...
#### Collinearity ####
####
##### HR: See test-collinearity.R for the following tests
cat("COLLINEARITY\n\n")
...
#### Interact ####
####
##### HR: See test-interact.R for the following tests
...
#### demean ####
####
##### HR: See test-demean.R for the following tests
chunk("DEMEAN")
...
##### HR: See test-hatvalues.R for the following tests
chunk("HATVALUES")
...
#### only.env ####
####
##### HR: See test-only.env.R for the following tests
...
#### Non linear tests ####
####
##### HR: See test-nonlinear.R for the following tests
chunk("NON LINEAR")
...
#### Lagging ####
####
##### HR: See test-lagging.R for the following tests
...
#### predict ####
####
##### HR: See test-predict.R for the following tests
chunk("PREDICT")
...
#### subset ####
####
##### HR: See test-subset.R for the following tests
chunk("SUBSET")
...
##### HR: See test-multiple.R for the following tests
chunk("Multiple")
...
chunk("IV")
##### HR: See test-IV.R for the following tests
...
##### HR: See test-model_matrix.R for the following tests
chunk("Model matrix")
...
##### HR: See test-fitstat.R for the following tests
