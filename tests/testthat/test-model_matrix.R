...
# base_bis <- Bases[[2]]
#
# patrick::with_parameters_test_that("model.matrix removes NA correctly",
#                                    {
...
# )
#
# patrick::with_parameters_test_that("model.matrix works properly with lagged variables",
#                                    {
