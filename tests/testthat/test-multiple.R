...
#   split = ~species
# )
# patrick::with_parameters_test_that("multiple estimations works properly for feols",
#                                    {
...
#     famly = famlys[l]
#   )
#   patrick::with_parameters_test_that("multiple estimations works properly for feglm",
#                                      {
#                                        est <- est_multi[[num_fmla]]
#
#                                        base_aux <- base[species_indx[[s]], ]
...
#   fsplit = ~species
# )
# patrick::with_parameters_test_that("multiple estimations with fixed effects works properly for feols",
#                                    {
...
#     famly = famlys[l]
#   )
#   patrick::with_parameters_test_that("multiple estimations with fixed effects works properly for feglm",
#                                      {
#                                        fmlas <- xpd(..lhs ~ x1 + ..rhs + x4 | species + fe2, ..lhs = lhs, ..rhs = all_rhs[1:n_rhs])
#                                        if (s == "all") {
#                                          res <- fixest_mod_select(model = Model, fmla = fmlas, base = base, famly = fmly, notes = FALSE)
...
#     famly = famlys[l]
#   )
#   patrick::with_parameters_test_that("multiple estimations with fixed effects works properly for femlm",
#                                      {
#                                        fmlas <- xpd(..lhs ~ x1 + ..rhs + x4 | species + fe2, ..lhs = lhs, ..rhs = all_rhs[1:n_rhs])
#                                        if (s == "all") {
#                                          res <- fixest_mod_select(model = Model, fmla = fmlas, base = base, famly = fmly, notes = FALSE)
...
#     famly = famlys[l]
#   )
#   patrick::with_parameters_test_that("multiple estimations with fixed effects works properly for feNmlm",
#                                      {
#                                        fmlas <- xpd(..lhs ~ x1 + ..rhs + x4 | species + fe2, ..lhs = lhs, ..rhs = all_rhs[1:n_rhs])
#                                        if (s == "all") {
#                                          res <- fixest_mod_select(model = Model, fmla = fmlas, base = base, famly = fmly, notes = FALSE)
