...
results_R = fread(here("DATA", "results_bench_R.txt"))
...
# The Julia results
julia_G1_raw = fread(here("DATA", "julia_bench_1FE.txt"))
julia_G2_raw = fread(here("DATA", "julia_bench_2FE.txt"))
julia_G3_raw = fread(here("DATA", "julia_bench_3FE.txt"))
...
fwrite(results_all, here("DATA", "results_all.txt"))
...
results_diff_R = fread(here("DATA", "results_diff_bench_R.txt"))[, -1]
...
results_diff_julia = fread(here("DATA", "julia_bench_diff.txt"))
...
fwrite(results_diff_all, here("DATA", "results_diff_all.txt"))
