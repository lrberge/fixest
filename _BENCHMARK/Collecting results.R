...
results_R = fread("BENCHMARK/DATA/results_bench_R.txt")

# Poisson
results_poisson =  results_R[family == "poisson", -1]

# We add the stata results
ppmlhdfe_G1_raw = fread("BENCHMARK/_STATA/ppmlhdfe_G1.txt")
ppmlhdfe_G2_raw = fread("BENCHMARK/_STATA/ppmlhdfe_G2.txt")
ppmlhdfe_G3_raw = fread("BENCHMARK/_STATA/ppmlhdfe_G3.txt")
...
# We add the stata results
reghdfe_G1_raw = fread("BENCHMARK/_STATA/reghdfe_G1.txt")
reghdfe_G2_raw = fread("BENCHMARK/_STATA/reghdfe_G2.txt")
reghdfe_G3_raw = fread("BENCHMARK/_STATA/reghdfe_G3.txt")
...
# The Julia results
julia_G1_raw = fread("BENCHMARK/DATA/julia_bench_1FE.txt")
julia_G2_raw = fread("BENCHMARK/DATA/julia_bench_2FE.txt")
julia_G3_raw = fread("BENCHMARK/DATA/julia_bench_3FE.txt")
...
# We add the stata results
nbreg_G1_raw = fread("BENCHMARK/_STATA/nbreg_G1.txt")
nbreg_G2_raw = fread("BENCHMARK/_STATA/nbreg_G2.txt")
nbreg_G3_raw = fread("BENCHMARK/_STATA/nbreg_G3.txt")
...
# We add the stata results
logit_G1_raw = fread("BENCHMARK/_STATA/logit_G1.txt")
logit_G2_raw = fread("BENCHMARK/_STATA/logit_G2.txt")
logit_G3_raw = fread("BENCHMARK/_STATA/logit_G3.txt")
...
fwrite(results_all, "BENCHMARK/DATA/results_all.txt")
...
results_diff_R = fread("BENCHMARK/DATA/results_diff_bench_R.txt")[, -1]

results_diff_reghdfe = fread("BENCHMARK/_STATA/reghdfe_diff.txt")
...
results_diff_julia = fread("BENCHMARK/DATA/julia_bench_diff.txt")
...
fwrite(results_diff_all, "BENCHMARK/DATA/results_diff_all.txt")
