...
#'
#' It is possible to compare the results of severeal estimations by using the function \code{\link[fixest]{esttable}}, and to export them to Latex using \code{\link[fixest]{esttex}}.
#'
#' @references
