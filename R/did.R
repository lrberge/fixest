...
#' @param bin.rel A list or a vector defining which values to bin. Only applies to the relative periods and \emph{not} the cohorts. Please refer to the help of the argument `bin` to understand the different ways to do the binning (or look at the help of [`bin`]).
