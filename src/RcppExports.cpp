...
// cpp_add_commas
std::string cpp_add_commas(double x, int r);
RcppExport SEXP _fixest_cpp_add_commas(SEXP xSEXP, SEXP rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type x(xSEXP);
    Rcpp::traits::input_parameter< int >::type r(rSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_add_commas(x, r));
    return rcpp_result_gen;
END_RCPP
}
// cpp_get_nb_threads
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_fixest_cpp_add_commas", (DL_FUNC) &_fixest_cpp_add_commas, 2},
