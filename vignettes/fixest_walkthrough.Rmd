...
Let's have an example using the Fulton fish market data ([Angrist, Grady, and Imbens 2000](https://academic.oup.com/restud/article-abstract/67/3/499/1547484?redirectedFrom=fulltext&login=false)). 
...
The paper uses the sea weather (measured in `speed2` and `wave2`) as a "supply shifter" to estimate the demand elasticity.
