...
# Econometrics sowftare and collinearity
...
In general the process of collinearity removal is as follows:
- for each explanatory variable, from left to right, *following the order of the variables given by the user* (this is important):
  - check wether the current variable is collinear with the variables previously done:
